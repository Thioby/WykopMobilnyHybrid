...
class LinksApi extends ApiResource {
  ...
  Future<VoteStateResponse> commentVoteUp(int linkCommentId, String linkId) async {
    ...
    return VoteStateResponse(
        votes: voteCount["vote_count"], votesPlus: voteCount["vote_count_plus"], state: LinkCommentVoteState.UP_VOTED);
  }
  ...
  Future<VoteStateResponse> commentVoteRemove(int linkCommentId, String linkId) async {
    ...
    return VoteStateResponse(
        votes: voteCount["vote_count"], votesPlus: voteCount["vote_count_plus"], state: LinkCommentVoteState.NOT_VOTED);
  }
  ...
  Future<LinkComment> addComment(int linkId, InputData data, {int commentId}) async {
    var linkComment;
    if (commentId != null) {
