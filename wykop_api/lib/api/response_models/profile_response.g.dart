...
Serializer<ProfileResponse> _$profileResponseSerializer = new _$ProfileResponseSerializer();
...
class _$ProfileResponseSerializer implements StructuredSerializer<ProfileResponse> {
  ...
  Iterable<Object> serialize(Serializers serializers, ProfileResponse object,
    ...
    final result = <Object>[
      ...
      'signup_at',
      serializers.serialize(object.signupAt, specifiedType: const FullType(String)),
      'followers',
      serializers.serialize(object.followers, specifiedType: const FullType(int)),
      'links_added_count',
      serializers.serialize(object.linksAddedCount, specifiedType: const FullType(int)),
      'links_published_count',
      serializers.serialize(object.linksPublishedCount, specifiedType: const FullType(int)),
      'avatar',
      serializers.serialize(object.avatarUrl, specifiedType: const FullType(String)),
      'rank',
    ...
    if (object.isBlocked != null) {
      result..add('is_blocked')..add(serializers.serialize(object.isBlocked, specifiedType: const FullType(bool)));
    }
    if (object.isObserved != null) {
      result..add('is_observed')..add(serializers.serialize(object.isObserved, specifiedType: const FullType(bool)));
    }
    if (object.background != null) {
      result..add('background')..add(serializers.serialize(object.background, specifiedType: const FullType(String)));
    }
    if (object.about != null) {
      result..add('about')..add(serializers.serialize(object.about, specifiedType: const FullType(String)));
    }
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'sex':
          ...
          break;
        case 'signup_at':
          result.signupAt = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case 'is_blocked':
          result.isBlocked = serializers.deserialize(value, specifiedType: const FullType(bool)) as bool;
          break;
        case 'followers':
          result.followers = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case 'is_observed':
          result.isObserved = serializers.deserialize(value, specifiedType: const FullType(bool)) as bool;
          break;
        case 'background':
          result.background = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case 'links_added_count':
          result.linksAddedCount = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case 'links_published_count':
          result.linksPublishedCount = serializers.deserialize(value, specifiedType: const FullType(int)) as int;
          break;
        case 'avatar':
          result.avatarUrl = serializers.deserialize(value, specifiedType: const FullType(String)) as String;
          break;
        case 'rank':
...
class _$ProfileResponse extends ProfileResponse {
  ...
  _$ProfileResponse._(
    ...
    if (linksPublishedCount == null) {
      throw new BuiltValueNullFieldError('ProfileResponse', 'linksPublishedCount');
    }
    if (avatarUrl == null) {
                        ...
                        $jc(
                            $jc(
                                $jc(
                                    $jc(
                                        $jc(
                                            $jc($jc($jc($jc(0, login.hashCode), color.hashCode), sex.hashCode),
                                                signupAt.hashCode),
                                            isBlocked.hashCode),
                                        followers.hashCode),
                                    isObserved.hashCode),
...
class ProfileResponseBuilder implements Builder<ProfileResponse, ProfileResponseBuilder> {
  ...
  set linksAddedCount(int linksAddedCount) => _$this._linksAddedCount = linksAddedCount;

  int _linksPublishedCount;
  int get linksPublishedCount => _$this._linksPublishedCount;
  set linksPublishedCount(int linksPublishedCount) => _$this._linksPublishedCount = linksPublishedCount;
