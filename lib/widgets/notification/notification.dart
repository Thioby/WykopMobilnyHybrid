    ...
    return Consumer<NotificationModel>(
      builder: (context, model, _) => Material(
        ...
        child: InkWell(
          onTap: () async {
            model.markAsRead();
            (Provider.of<ListModel<NotificationDto, NotificationModel>>(context, listen: false)
          ...
          child: Column(
            children: <Widget>[
              Padding(
                padding: EdgeInsets.only(top: 6.0, bottom: 6.0, left: 14.0, right: 18.0),
                child: Row(
                          ...
                          children: <Widget>[
                            RichText(
                              ...
                              text: TextSpan(
                                children: [
                                  TextSpan(
                                    text: model.body.substring(0, model.body.indexOf(' ')),
                                    style: TextStyle(
                                      fontSize: 15.0,
                                      height: 1.1,
                                      fontWeight: FontWeight.w500,
                                      color: model.author != null
                                          ? Utils.getAuthorColor(model.author.color, context)
                                          : Theme.of(context).textTheme.headline.color,
                                    ),
                                  ),
                                  TextSpan(
                                    text: model.body
                                        .substring(model.body.indexOf(' '), model.body.length)
                                        .replaceAll('\n', ' '),
                                    style: TextStyle(
                                      fontSize: 15.0,
                                      height: 1.1,
